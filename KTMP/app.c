...
# 12 "/home/ls/Desktop/OLSONET/PICOS/PicOS/PLibs/Serial/ser.h"
int ser_out (word, const char*);
int ser_in (word, char*, int);
int ser_outb (word, const char*);
# 1 "/home/ls/Desktop/OLSONET/PICOS/PicOS/PLibs/Serial/serf.h"
...
# 11 "/home/ls/Desktop/OLSONET/PICOS/PicOS/PLibs/Serial/form.h"
...
# 9 "/home/ls/Desktop/OLSONET/PICOS/PicOS/PLibs/Serial/serf.h"



int ser_outf (word, const char*, ...);
int ser_inf (word, const char*, ...);
# 16 "/home/ls/Desktop/OLSONET/PICOS/PicOS/kernel/kernel.h"
...
# 67 "/home/ls/Desktop/OLSONET/PICOS/PicOS/kernel/kernel.h"
...
# 10 "/home/ls/Desktop/OLSONET/PICOS/PicOS/CC13XX/phys_cc1350.h"
void phys_cc1350 (int, int);
# 12 "/home/ls/Desktop/OLSONET/PICOS/PicOS/VLibs/PlugNull/plug_null.h"
...
# 188 "app.cc"
  ...
  proceed (SEND_RETRIEVE);
        ...
        packet = tcv_wnps (SEND_RETRIEVE, sfd, 12, 0);
...
#define HANDLE_DISC_REQ 3
#define SEND_DISC_RESP 4
#define HANDLE_DISC_RESP 5
#define HANDLE_CREATE 6
#define SEND_CREATE_RESPONSE 7
#define HANDLE_DELETE 8
#define SEND_DELETE_RESPONSE 9
#define HANDLE_RETRIEVE 10
#define SEND_RETRIEVE_OK_RESP 11
#define SEND_RETRIEVE_FAIL_RESP 12
# 285 "app.cc"
...
# 285 "app.cc"
 ...
 case RECEIVE : __stlab_RECEIVE: {
 ...
 } case DROP_PACKET : __stlab_DROP_PACKET: {
  tcv_endp(packet);
  proceed (RECEIVE);
  ...
  response = tcv_wnps (SEND_DISC_RESP, sfd, 10, 0);
  ...
  *q++ = sender_id;
  ...
  response = tcv_wnps (SEND_CREATE_RESPONSE, sfd, 12, 0);
  ...
  *q++ = 0;
  ...
  response = tcv_wnps (SEND_DELETE_RESPONSE, sfd, 12, 0);
  ...
  *q++ = 0;
  ...
  response = tcv_wnps (SEND_RETRIEVE_OK_RESP, sfd, 32, 0);
  ...
  *q++ = 0;
  ...
  response = tcv_wnps (SEND_RETRIEVE_FAIL_RESP, sfd, 12, 0);
...
# 665 "app.cc"
 ...
 case Reset_Neighbors : __stlab_Reset_Neighbors: {
  ...
  find_req_num = (byte)((word)(lrnd () >> 16));
  find_active = 1;


  packet = tcv_wnps (Send_Discovery_Request, sfd, 10, 0);
  packet[0] = 0;
...
# 743 "app.cc"
 ...
 case Ask_Destination_ID : __stlab_Ask_Destination_ID: {
  ...
  packet = tcv_wnps (Send_delete_request, sfd, 12, 0);
...
#define Ask_Group_ID 14
#define Ask_Group_ID_In 15
#define Group_Id_Finish 16
#define Ask_Node_ID 17
#define Ask_Node_ID_In 18
#define Node_Id_Finish 19
#define Show_LocalDB 20
#define Show_LocalDB_Item 21
#define Reset_DB 22
# 852 "app.cc"
